...
function App() {
    ...
    const [mensajes, setMensajes] = useState([
        {
            id: 1,
            tipo: "usuario",
            texto: "¿Cómo puedo mejorar mi interfaz?",
            hora: obtenerHoraActual(),
        },
        {
            id: 2,
            tipo: "asistente",
            texto: "Puedes mejorarla cuidando contraste, jerarquía visual y accesibilidad.",
            hora: obtenerHoraActual(),
        },
    ]);
    ...
    const respuestas = [
        ...
        "Usa colores con buen contraste para que el contenido sea legible.",
        "Una interfaz clara ayuda a que el usuario sepa qué hacer sin confundirse.",
    ];
